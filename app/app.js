...
class App extends React.Component {
  ...
  constructor(props) {
    ...
    this.state = { lists: [], gerandoListas: 0, ordenandoListas: 0 };
  ...
  sortLists() {
    ...
    this.state.lists.forEach(async (item, index) => {
      let percentage = (100 / 6100 * item.list.length);
        ...
        <div className='row'>
          <div className='col-md-12'>
            <div className='row'>
              ...
              <div className='col-md-6'>
                <button onClick={ this.compareLists } className='btn btn-lg btn-primary'>Comparar Listas</button>
              </div>
            </div>
